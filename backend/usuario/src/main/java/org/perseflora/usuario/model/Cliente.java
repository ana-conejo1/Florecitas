...
public class Cliente {
    ...
    @Column(name = "fecha_nacimiento_cliente", nullable = false, columnDefinition = "DATETIME")
    ...
    public Cliente(long idCliente, String nombre, String apellido, LocalDateTime fechaNacimiento, String telefono, String email, String password, String domicilio) {
